...
Bu brief `attio.com` kaynağından çıkarılan tasarım sinyallerini kullanır. Kaynak siteyi kopyalama.
...
- Tam yuvarlak (pill / border-radius:999px) rozet ve etiket enflasyonu YOK. (bu sitede: 0 adet)
...
- Birbirinin tıpatıp aynısı 3'lü kart dizisi YOK. (bu sitede: 4 adet)
...
- Sayfanın tamamını ortalama. (bu sitede: %2)
- Rastgele boşluk değerleri kullanma. (bu sitede: %87)
...
- Sayfa tipleri: `content/blog, home, pricing/catalog, unknown`
- Baskın sectionlar: `generic-block, navbar, content, footer, card-grid, gallery, hero`

## Kalite Skoru

- Taranan / keşfedilen sayfa: `8` / `64`
- Crawl coverage: `0.12`
- Design signal strength: `1.0`
- Section confidence: `0.73`
- Component confidence: `0.05`
