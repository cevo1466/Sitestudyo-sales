...
Bu brief `folk.app` kaynağından çıkarılan tasarım sinyallerini kullanır. Kaynak siteyi kopyalama.
...
- Tam yuvarlak (pill / border-radius:999px) rozet ve etiket enflasyonu YOK. (bu sitede: 1 adet)
- Her kutuya birden yuvarlak köşe + gölge verme. (bu sitede: %0)
...
- Cam efekti (backdrop-filter: blur) yüzey enflasyonu YOK. (bu sitede: 0 adet)
- Birbirinin tıpatıp aynısı 3'lü kart dizisi YOK. (bu sitede: 2 adet)
...
- Sayfanın tamamını ortalama. (bu sitede: %4)
- Rastgele boşluk değerleri kullanma. (bu sitede: %93)
- Onlarca farklı punto kullanma. (bu sitede: 12 adet)
- WCAG AA eşiğinin altında metin/zemin çifti bırakma. (bu sitede: %0)
...
- Sayfa tipleri: `home, unknown`
- Baskın sectionlar: `hero, generic-block, gallery, content, form, card-grid, footer`

## Kalite Skoru

- Taranan / keşfedilen sayfa: `2` / `72`
- Crawl coverage: `0.03`
- Design signal strength: `1.0`
- Section confidence: `0.72`
- Component confidence: `0.13`
